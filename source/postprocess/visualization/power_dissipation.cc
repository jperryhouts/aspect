...
#include <aspect/postprocess/visualization/power_dissipation.h>
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ...
      Power ()
        :
        DataPostprocessorScalar<dim> ("power",
                                      update_gradients | update_values | update_q_points)
      {}
        ...
        for (unsigned int q=0; q<n_quadrature_points; ++q)
          {
            ...
            computed_quantities[q](0) = stress * strain_rate;
          }
      }
    }
  }
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ASPECT_REGISTER_VISUALIZATION_POSTPROCESSOR(Power,
                                                  "power dissipation",
